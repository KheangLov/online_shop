...
@section('content')
<a href="{{ route('sub_cate') }}" class="btn btn-primary btn-lg btn-add mb-5">Sub-Category</a>
<div class="row">
    <div class="col-sm-4">
        <div class="card card-custom bg-color">
            <div class="card-header d-flex bd-highlight">
                <h2 class="p-2 w-100 bd-highlight">{{ isset($edit) && $edit ? 'Edit' : 'Add' }} Category</h2>
            </div>
            <div class="card-body">
    ...
    <div class="col-sm-8">
        <div class="card card-custom bg-color">
            <div class="card-header d-flex bd-highlight">
                <h2 class="p-2 w-100 bd-highlight">Category List</h2>
